...
/* Definitions for WSTask */
osThreadId_t WSTaskHandle;
const osThreadAttr_t WSTask_attributes = {
  .name = "WSTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
...
int main(void)
{
  ...
  LCDQueueHandle = osMessageQueueNew (8, sizeof(SensorMsg_t), &LCDQueue_attributes);
  ...
  /* creation of WSTask */
  WSTaskHandle = osThreadNew(StartWSTask, NULL, &WSTask_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : BTN_EXTI10_Pin */
  GPIO_InitStruct.Pin = BTN_EXTI10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(BTN_EXTI10_GPIO_Port, &GPIO_InitStruct);
